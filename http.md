...
PUT methodu bir veri uzerinde degisiklik yaparken kullandigimiz bir methoddur bu sayede yaptigimiz degisiklikleri server'a bildirebiliyoruz lakin cogu zaman put yerine POST kullanilabiliyor birazdan anlatacagim PATCH methodu icinde ayni sey gecerli. Tabiki bu dogru bir kulanim degil her methodu amacina gore kullanmakta fayda var. PUT uzerinden bir ornek vermek istedim lakin cogu plartfomlarda degisiklik icin POST methodunu kullandigini gordum yada ben bir sekilde PUT methodunun kullanildigi kismi bulamadim Twitter, Instagram gibi uygulamalar uzerinde profilimde degisiklikle yaparak PUT requestini gorebilmeyi umuyordum fakat olmadi. Daha once PUT method'u ile ilgili bir deneyimim vesaire olmadigi icin de burada her hangi bir ornek veremiyorum lakin bir kaynak birakabilirim: 
...
PATCH methodu da PUT gibi calisir. Tek farki PUT gibi genel bir veriyi degil veri icindeki kucuk bir kisim icin degisiklikler yapabiliyor olusudur. Ornegin buyuk bir veri tutuldugunu ve o veri icerisinde yazim hatasi oldugunu dusunun o yazim hatasini duzeltmek icin komple tum veriyi guncelleme talebinde bulunmamiza gerek yoktur sadece ufak bir veri eklemek istedigimizden PATCH methodu kullanilabilir. Yine bunada bir ornek vermeyecegim fakat bir kaynak birakacagim:
